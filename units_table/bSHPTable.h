...
// File : bSHPTable.h
// Project : MacMapSuite
// Purpose : Header file : Shape table class (ShapeLib C++ wrapper)
...
#ifndef __bSHPTable__
#define __bSHPTable__
...
class bSHPTable : public bStdTable{
	public:
		bSHPTable						(	const char* path,
											const char* name,
											bool create, 
											double reso,
											int srid,
	...
	protected:
		virtual ivertices* shape2vxs	(	SHPObject* o);
		virtual SHPObject* vxs2shape	(	int o, 
											ivertices* vxs);
		virtual int	db2shp				(	int sign);
		virtual int	shp2db				(	int sign);
