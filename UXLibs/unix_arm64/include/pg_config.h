...
#define CONFIGURE_ARGS " '--prefix=/Library/Frameworks/MacMapSuite.framework/Versions/A/unix'"
...
#define PG_VERSION_STR "PostgreSQL 15.2 on aarch64-apple-darwin22.1.0, compiled by Apple clang version 14.0.0 (clang-1400.0.29.202), 64-bit"
